...
/** Order: Lead Qualifier first (hero SKU), then Inbox Triage, Weekly Report. */
export const caseStudies: CaseStudy[] = [
  {
    ...
    notes:
      "Walkthrough Loom published. Named client reference / authorized metrics still pending formal publicity approval — do not invent logos.",
  },
  {
    slug: "inbox-triage",
    ...
    notes:
      "Walkthrough Loom published. Named references available subject to client publicity approvals.",
  },
  {
    slug: "weekly-report",
    ...
    notes:
      "Walkthrough Loom published. Formal testimonial assets still pending engagement authorization.",
  },
];
